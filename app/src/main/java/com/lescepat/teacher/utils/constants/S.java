package com.lescepat.teacher.utils.constants;
...
public class S
{
    ...
    public static String error_empty_id              = "ID cannot be empty!";
    public static String error_forget_password       = "Reset Password Failed";
    public static String error_empty_password        = "Password cannot be empty!";
    public static String error_no_data               = "No Data";
